...
namespace dx11
{
    ...
    public:
        ...
        void TestUpdateCode()
        {
            ...
            static auto vertexShader = ResourceManager::Instance().LoadVertexShaderFromFile(L"VertexShader.cso");
            static auto pixelShader = ResourceManager::Instance().LoadPixelShaderFromFile(L"PixelShader.cso");
