...
namespace dx11
{
	...
	public:
		...
		void TestUpdateCode()
		{
			...
			static auto vertexShader = ResourceManager::Instance().LoadVertexShaderFromFile("VertexShader.cso");
			static auto pixelShader = ResourceManager::Instance().LoadPixelShaderFromFile("PixelShader.cso");
			...
			device->CreateInputLayout(layout, ARRAYSIZE(layout), nullptr, 0, &layout2);

			deviceContext->IASetInputLayout(layout2);
