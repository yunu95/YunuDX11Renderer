...
export namespace imgui
{
    ...
    bool UpdateImgui()
    {
        // Poll and handle messages (inputs, window resize, etc.)
                 // See the ImguiWndProc() function below for our to dispatch events to the Win32 backend.
        MSG msg;
        ...
        {
            ImGui::Begin("Test Over", 0, ImGuiWindowFlags_NoBringToFrontOnFocus);
            ImGui::End();
        }

        {
            ImGui::Begin("Test Back", 0, ImGuiWindowFlags_NoBringToFrontOnFocus);
            ImGui::End();
        }
