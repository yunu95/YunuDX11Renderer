...
inline Matrix Matrix::CreatePerspectiveFieldOfView(float verticalFov, float aspectRatio, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveFovRH(verticalFov, aspectRatio, nearPlane, farPlane));
    return R;
}
